<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="Ubicacion.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="Ubicacion" %>
